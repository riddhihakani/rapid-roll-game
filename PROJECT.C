...
void logo(){
	...
	setcolor (13);
	outtextxy (55,50,"Computer Graphics Project");
	outtextxy (15,100,"Created by Computer Engineering SE-B Students:");
	outtextxy (55,150,"Rishi Parekh(sap:60004180082)");
	outtextxy (55,200,"Riddhi Hakani(sap:60004180080)");
	setcolor(100);
...
int screen(){
	...
	while(1){
		...
		if(click(250,250,400,300,"Exit")==0){
		    exit(0);
		}
